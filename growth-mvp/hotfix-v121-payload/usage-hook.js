...
async function main() {
    ...
    try {
        ...
        writeFileSync(join(SESSIONS_DIR, `${safeId}.json`), JSON.stringify(record, null, 2), "utf8");
        log(`recorded session=${safeId} total=${record.total_tokens} fresh=${record.fresh_tokens} ` +
...
//# sourceMappingURL=usage-hook.js.map