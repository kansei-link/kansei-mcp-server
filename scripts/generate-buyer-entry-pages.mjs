...
<p>変更を加える前に何を記録しておけばよかったかは、<a href="/insights/ai-taisaku-doko-kara-hajimeru-2026.html">別の記事</a>にまとめました。</p>
...
<p class="note">この測定は自社が対象で、AIの回答に何が含まれたかを数えたものです。各社の品質評価ではありません。生成AIの回答は実行ごとに揺れるため、1回の結果で断定しないでください。</p>`,
  ...
  },
  {
    ...
    body: `
<p class="lead">私たちは基準点を取らずに施策を打ち、<strong>効果があったのかどうかを判定できなくなりました</strong>。同じことを避けるために、変更を加える前に何を記録しておくかを整理します。</p>

<h2>何が起きたか</h2>
<p>構造化データ、llms.txt、想定質問の掲載を先に行い、そのあとで測りました。<strong>言及は0</strong>。ここで困ったのは、次のどれなのかが分からないことです。</p>
<ul>
<li>施策が間違っていたのか</li>
...
<h2>変更前に記録しておく4項目</h2>
<p>あとから「効いたのか」を判定できるようにするために、変更を加える前に残しておく項目です。</p>
<ol>
